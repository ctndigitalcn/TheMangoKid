    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Role", t => t.Account_Role)
                ...
                c => new
                    {
                        ...
                        Coupon_Code = c.String(nullable: false, maxLength: 50, unicode: false),
                        Generated_At = c.DateTime(nullable: false),
                        Expire_At = c.DateTime(nullable: false),
                        Discount_Percentage = c.Int(nullable: false),
                        Quantity = c.Int(nullable: false),
                        Created_By = c.Guid(),
                        TobeAppliedOnCategory = c.String(maxLength: 50, unicode: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Account", t => t.Created_By)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Guid(nullable: false),
                        Album_Name = c.String(nullable: false, maxLength: 50, unicode: false),
                        Album_Creation_Date = c.DateTime(nullable: false),
                        Total_Track = c.Int(nullable: false),
                        Submitted_Track = c.Int(nullable: false),
                        PurchaseTrack_RefNo = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.PurchaseRecord", t => t.PurchaseTrack_RefNo)
                ...
                c => new
                    {
                        ...
                        Track_Id = c.Guid(nullable: false),
                        Submitted_At = c.DateTime(nullable: false),
                        StoreSubmissionStatus = c.Byte(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.SingleTrackDetail", t => t.Track_Id)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ArtworkDetail", t => t.Artwork_Id)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Artwork_Link = c.String(nullable: false, unicode: false),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Guid(nullable: false),
                        Ep_Id = c.Guid(nullable: false),
                        Track_Id = c.Guid(nullable: false),
                        Submitted_At = c.DateTime(nullable: false),
                        StoreSubmissionStatus = c.Byte(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ExtendedPlay", t => t.Ep_Id)
                .ForeignKey("dbo.SingleTrackDetail", t => t.Track_Id)
                .Index(t => t.Ep_Id)
                .Index(t => t.Track_Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Guid(nullable: false),
                        Ep_Name = c.String(nullable: false, maxLength: 50, unicode: false),
                        Ep_Creation_Date = c.DateTime(nullable: false),
                        Total_Track = c.Int(nullable: false),
                        Submitted_Track = c.Int(nullable: false),
                        PurchaseTrack_RefNo = c.Guid(nullable: false),
                    })
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Account", t => t.User_Account_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SingleTrackDetail", "Artwork_Id", "dbo.ArtworkDetail");
            ...
            DropIndex("dbo.SingleTrackDetail", new[] { "Artwork_Id" });
